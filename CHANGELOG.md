...
- Npm-compat polish — publish-safe workspace specs, save-exact/prefix, outdated/upgrade latest, overrides, ci, and hardening (#4) ([65262d7](https://github.com/binbandit/snpm/commit/65262d7e1055bc95998edf576c1857ba97c31640))
...
- *(security)* Scope tarball auth to announcing registry origin ([4bbd577](https://github.com/binbandit/snpm/commit/4bbd577daafdcc4a9075046a8dfdf9b3b89d7bf5))
...
- *(node)* Document Node.js version manager and integration ([e8822c4](https://github.com/binbandit/snpm/commit/e8822c4a5f641f8b8de32c5676be1dc6fd1dd07c))
...
- *(store)* Stream tarball extraction concurrently with download ([7cdfbc6](https://github.com/binbandit/snpm/commit/7cdfbc6cad117a96e059d547ce6d5cb05d7c41e1))
- *(store)* Preallocate tarball cache file and buffer disk reads ([66c0e09](https://github.com/binbandit/snpm/commit/66c0e096c3d6842c449eaaeab6201aff7cea6ee6))
- *(lockfile)* Add bincode sidecar for fast loads ([23630c8](https://github.com/binbandit/snpm/commit/23630c8991a6bb61e400302880c65ebb23a9e96d))
- *(lifecycle)* Run dependency scripts in parallel ([f6c72c8](https://github.com/binbandit/snpm/commit/f6c72c855d6a5526329471f1466e96a7f9fa4503))
- *(store)* Revert tarball streaming in favor of buffered download ([3721b40](https://github.com/binbandit/snpm/commit/3721b40e49876fb305ee279172931a456a621372))
- *(store)* Raise extract concurrency cap from 8 to 32 ([5a6ddd2](https://github.com/binbandit/snpm/commit/5a6ddd2bcceba275f081d3bd459af4f39c86c76d))
- *(store)* Collapse per-package extraction into one blocking task ([84c4ac4](https://github.com/binbandit/snpm/commit/84c4ac4002bfc08ed9c91530e8e4b5a5f8ba775d))
- *(linker)* Skip wasted ENOENT cleanup in cold-path slots ([f2be2ed](https://github.com/binbandit/snpm/commit/f2be2ed42cbf2de015d010cd0475555efa69454f))
- *(store)* Extract directly to final dir on cold path; drop set_len no-op ([97173d3](https://github.com/binbandit/snpm/commit/97173d316f45a9251987e10c1a8e7b1d1346803b))
...
- *(store)* Cover streaming-extract error paths; truncate cached blob to actual size ([ece3818](https://github.com/binbandit/snpm/commit/ece3818705250b53ca87c14cebe09e644e88b717))
- *(lockfile)* Cover sidecar invalidation and round-trip edge cases ([4c7a654](https://github.com/binbandit/snpm/commit/4c7a65475f65375518a0e2e0ec95096f88c8782c))
- *(lifecycle)* Cover empty / blocked / mixed / failure paths ([7c29867](https://github.com/binbandit/snpm/commit/7c29867f3432a1ad149db30ac60e86fa3e5be6c3))
...
- *(release)* Bump version to 2026.4.14 [skip ci] ([838f902](https://github.com/binbandit/snpm/commit/838f9020e3041710a708f6b855d76beef79596ba))
- *(release)* Merge 2026.4.14 release [skip ci] ([e7b008a](https://github.com/binbandit/snpm/commit/e7b008a14dde9129e804d94ba30e0d07341e4ba6))
- *(release)* Bump version to 2026.4.15 [skip ci] ([bc0e9bb](https://github.com/binbandit/snpm/commit/bc0e9bb7862294760b5dcaf9eebbf7e922d577dc))
- *(release)* Merge 2026.4.15 release [skip ci] ([2365f5a](https://github.com/binbandit/snpm/commit/2365f5a641c58283d144f03ea601917bdfd5ac38))
- *(release)* Bump version to 2026.4.16 [skip ci] ([818e792](https://github.com/binbandit/snpm/commit/818e792a1228168512fca1291f020cecc1a8b132))
- *(release)* Merge 2026.4.16 release [skip ci] ([83a589d](https://github.com/binbandit/snpm/commit/83a589db46bfedc405c25094fb9944e2caca89d9))
- *(release)* Bump version to 2026.4.17 [skip ci] ([f7d9a3e](https://github.com/binbandit/snpm/commit/f7d9a3ed37f1898f853b63137300bd59c44b43c1))
...
- *(release)* Bump version to 2026.4.24 [skip ci] ([f789ada](https://github.com/binbandit/snpm/commit/f789adae1b6f3ee282921b0c24f7ee0647c39435))
- *(release)* Merge 2026.4.24 release [skip ci] ([42f2478](https://github.com/binbandit/snpm/commit/42f247851ee353bbf5d40f273cd3f3bd2a4a283f))
- *(release)* Bump version to 2026.4.25 [skip ci] ([79f7603](https://github.com/binbandit/snpm/commit/79f76038562a893c680712de541764585cce3d70))
- *(release)* Merge 2026.4.25 release [skip ci] ([e9252f8](https://github.com/binbandit/snpm/commit/e9252f8350b2ce94dabca08eb5b6a7638e5f5b55))
- *(release)* Bump version to 2026.4.26 [skip ci] ([5475601](https://github.com/binbandit/snpm/commit/547560190492925216639437d0468566ffb6b255))
- *(release)* Merge 2026.4.26 release [skip ci] ([2c33e8f](https://github.com/binbandit/snpm/commit/2c33e8f26df88fc3ceb9d8f1975602a07de7782a))
- *(release)* Bump version to 2026.4.27 [skip ci] ([f711f56](https://github.com/binbandit/snpm/commit/f711f56b9ce5c93cd54d6a61e443c5ccbe045be3))
...
- *(release)* Bump version to 2026.7.3 [skip ci] ([ba85588](https://github.com/binbandit/snpm/commit/ba855883842e6dc6de12762ad2e8dfabee4881e5))
- *(release)* Merge 2026.7.3 release [skip ci] ([0ac614a](https://github.com/binbandit/snpm/commit/0ac614afe6000990135ef872bff561a9406fd4e3))
- *(release)* Bump version to 2026.7.3-r.1 [skip ci] ([d6c8057](https://github.com/binbandit/snpm/commit/d6c80577eff90f5f1ac4a04261cf28db2e2b1125))
